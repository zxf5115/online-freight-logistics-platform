  ...
  <el-form label-width="100px" ref="dataForm" :model="dataForm" :rules="dataRule">
    <el-row>
      <el-col :span="20" :offset="2">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item class="title" :label="$t('course.point.question.answer')" prop="answer">
              <el-input type="textarea" v-model="dataForm.answer"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/${this.model}/explain`),
              method: 'post',
