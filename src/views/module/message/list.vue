    ...
    <div class="admin_main_block">
      <div class="admin_main_block_top">
        ...
        <div class="admin_main_block_right">
          <div>
            <el-button v-if="isAuth('module:message:delete')" type="danger" icon="el-icon-delete" @click="deleteHandle()">
      ...
      <div class="admin_main_block_top">
        <div class="admin_main_block_left">
          <div>
            <el-input v-model="dataForm.title" :placeholder="$t('common.please_input') + $t('notice.title')" clearable>
            </el-input>
          </div>
          <div>
        ...
        <el-table :data="dataList" v-loading="dataListLoading" @selection-change="selectionChangeHandle">
          ...
          <el-table-column :label="$t('common.handle')" fixed="right" width="120">
            <template slot-scope="scope">
              <el-button v-if="isAuth('module:message:delete')" type="danger" icon="el-icon-delete" @click="deleteHandle(scope.row.id)">
                {{ $t('common.delete') }}
              </el-button>
            </template>
          </el-table-column>
